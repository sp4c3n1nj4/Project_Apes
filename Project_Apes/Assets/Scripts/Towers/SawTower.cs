...
public class SawTower : Tower
{
    ...
    public override void Attack()
    {
        ...
        hits3 = Physics.RaycastAll(TileOffsetPosition(0, -1.5f), TileOffsetPosition(0, 1.5f), tilerange + 1, LayerMask.GetMask("Enemy"));
    ...
    private void OnDrawGizmos()
    {
        ...
        Gizmos.DrawLine(TileOffsetPosition(-1, -1.5f),TileOffsetPosition(-1, 1.5f));
        Gizmos.DrawLine(TileOffsetPosition(0, -1.5f), TileOffsetPosition(0, 1.5f));
    }
